...
let make = () => {
  ...
  <Grid.Container> 
    ...
    <div style=textFieldStyle>
      <Item> <TextField label="New Password" _type="password" name="password" variant=TextField.Variant.outlined fullWidth=true /> </Item>
    </div>
    <div style=textFieldStyle>
      <Item> <TextField label="New Password Confirmation" _type="password" name="password" variant=TextField.Variant.outlined fullWidth=true /> </Item>
    </div>
